...
//         ...state,
//         successFetch: true,
//         // ESTE ACA YA LO HACE RESET HOME: inputToSearch: "",
//       };
//     }
//     case ORDER_BY: {
...
//       };
//     }
//     case RESET_HOME: { //aca puedo quitarlo y usar la combiancion de:
//resetgamebyname, resetinputs (todos), cleangamestorender( nueva). 
//       return {
//         ...state,
//         gamesByName: [],
//         gamesToRender: state.allVideogames,
...
//     case RESET_INPUT_FILTER:{ 
            /*aca podria preguntar primero si gamesByname tiene algo,
            si lo tiene, gamesTorender lo renderiza y luego resetea, sino
            solo resetea y me ahorro la funcion savedByname antes llamada setByName */
//       return {
//         ...state,
//         inputForFilter: "no filter",
//         filterApplied: false
